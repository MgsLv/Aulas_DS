...
class GuiCadastroFilmes extends JFrame {
    ...
    public void inicializarcomponentes() {
        ...
        btLocalizar = new JButton(null, new ImageIcon("icones/localizar.gif"));
        ...
        btSair= new JButton(null, new ImageIcon("icones/sair.gif"));
        ...
        btGravar.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if (tfProdutora.getText().equals("")) {
                    JOptionPane.showMessageDialog(null, "A produtora não pode ser vazio!");
                    tfProdutora.requestFocus();
                    return;
                }
                if (tfDataCompra.getText().equals("")) {
                    JOptionPane.showMessageDialog(null, "A data de compra não pode ser vazio!");
                    tfDataCompra.requestFocus();
                    return;
                }
                filmes.filme.setCodigo(tfCodigo.getText());
                filmes.filme.setTitulo(tfCodigo.getText());
                filmes.filme.setGenero(tfCodigo.getText());
                filmes.filme.setProdutora(tfCodigo.getText());
                filmes.filme.setDataCompra(tfCodigo.getText());
